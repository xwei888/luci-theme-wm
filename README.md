...
**当前版本：1.13.29-1 · 软件包架构：all · 许可证：Apache-2.0**
...
- `luci-theme-wm_1.13.29-1_all.ipk`：安装包。
- `luci-theme-wm-1.13.29-source.tar.gz`：对应版本源码。
- `SHA256SUMS`：文件校验值。
...
- 文件管理器采用自适应路径栏与宽表格，单独高亮当前标签；窄屏显示文件卡片，统一排序、文件操作图标及编辑、设置页面。
...
```sh
opkg install /tmp/luci-theme-wm_1.13.29-1_all.ipk
