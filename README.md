...
**当前版本：1.13.25-1 · 软件包架构：all · 许可证：Apache-2.0**
...
- `luci-theme-wm_1.13.25-1_all.ipk`：安装包。
- `luci-theme-wm-1.13.25-source.tar.gz`：对应版本源码。
- `SHA256SUMS`：文件校验值。
...
```sh
opkg install /tmp/luci-theme-wm_1.13.25-1_all.ipk
